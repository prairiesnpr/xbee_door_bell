...
static attribute door_basic_attr[] {{0x0004, manuf, 10, ZCL_CHAR_STR}, {0x0005, (uint8_t*)"DoorBell", 8, ZCL_CHAR_STR}};
static attribute temp_basic_attr[] {{0x0004, manuf, 10, ZCL_CHAR_STR}, {0x0005, (uint8_t*)"Temp", 4, ZCL_CHAR_STR}};
static attribute door_attr[] {{0x0000, 0x00, 1, ZCL_BOOL}};
static attribute temp_attr[] = {{0x0000, 0x00, 2, ZCL_UINT16_T}};
static attribute humid_attr[] = {{0x0000, 0x00, 2, ZCL_UINT16_T}};

static Cluster door_in_clusters[] = {Cluster(BASIC_CLUSTER_ID, door_basic_attr, 2), Cluster(ON_OFF_CLUSTER_ID, door_attr, 1)};
...
static Endpoint ENDPOINTS[NUM_ENDPOINTS] = {
  Endpoint(1, ON_OFF_OUTPUT, door_in_clusters, out_clusters, 2, 0),
